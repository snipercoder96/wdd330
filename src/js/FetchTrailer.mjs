            ...
            <div class="grid-area2">
                ...
                <div class="movie-main-cast">
                    ...
                    ? `https://image.tmdb.org/t/p/w200${actor.profile_path}`
                            : 'hhttps://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExcXZtZThvZ25sYm5qMDA1OHBmczU4NHJlZnBsMGNyaXgxdG5oOHVzdCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/qHXSYtyW0kANmLLzcG/giphy.gif'}" 
                                    alt="${actor.name}" 
